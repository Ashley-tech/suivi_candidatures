...
class OffreController extends Controller
{
    ...
    public function ajouterOffre(Request $request) {
        $request->validate([
            ...
            'adresse_comp_entreprise' => 'nullable|string|max:255',
            'cp_entreprise' => 'nullable|string|max:20',
            'ville_entreprise' => 'nullable|string|max:255',
            'pays_entreprise' => 'nullable|string|max:255',
            'nom_recruteur' => 'nullable|string|max:255',
            'prenom_recruteur' => 'nullable|string|max:255',
            'email_entreprise' => 'nullable|email|max:255',
            'tel_entreprise' => 'nullable|string|max:20',
